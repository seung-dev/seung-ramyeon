...
public enum SCommonOAuth2Provider {
	...
	GOOGLE {
		...
		public Builder getBuilder(String registration_id) {
			...
			builder.userNameAttributeName(SIdTokenClaimNames._S_CLAIM_SUB);
	...
	, FACEBOOK {
		...
		public Builder getBuilder(String registration_id) {
			...
			builder.userNameAttributeName(SIdTokenClaimNames._S_CLAIM_ID);
	...
	, NAVER {
		...
		public Builder getBuilder(String registration_id) {
			...
			builder.userNameAttributeName(SIdTokenClaimNames._S_CLAIM_RESPONSE);
